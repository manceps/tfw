# -*- coding: utf-8 -*-
"""Mueller Report - UnRedacted.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1XzSK56UvPQnpv_syH5UHmQ9bA2Ysp_Py
...
def show_text_as_ints(text_as_int):
...
* The RNN state returned by the model is fed back into the model so that it now has more context, instead than only one word.

* After predicting the next word, the modified RNN states are again fed back into the model,
# It learns as it gets more context from the previously predicted words.
...
make paragraphs and imitates original text writing vocabulary.
